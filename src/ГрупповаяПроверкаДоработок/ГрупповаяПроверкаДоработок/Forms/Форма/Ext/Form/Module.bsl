...
#Область НеИспользуются_Удалить
...
Функция Формы_XSLT_СтруктураВСтрокуКлючЗначениеПреобразователь() Экспорт
	...
	СтрокаДляЗагрузки = "
		...
		|</xsl:stylesheet>
		|";
	Преобразователь.ЗагрузитьИзСтроки(СтрокаДляЗагрузки);
...
Функция Формы_ТекстОшибкиXML(Ошибка) Экспорт
	...
	Если ЗначениеЗаполнено(Ошибка.ОбъектМетаданных) ИЛИ ЗначениеЗаполнено(Ошибка.УточнениеРасположения) Тогда
		...
		ДанныеОшибки = Новый Структура("ОбъектМетаданных, УточнениеРасположения", 
			Ошибка.ОбъектМетаданных, Ошибка.УточнениеРасположения);
		
		Ошибка.ОбъектыМетаданных.Добавить(ДанныеОшибки);
