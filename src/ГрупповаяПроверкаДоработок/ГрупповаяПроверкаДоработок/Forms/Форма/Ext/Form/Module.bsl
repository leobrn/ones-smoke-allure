...
Процедура ДобавитьИнформациюПроверки(ТаблицаИнформации, РежимПроверки, ПроверяемыйОбъект, 
	Данные = Неопределено, КраткоеОписание = "", Описание = "")
		...
		Если ТекФорма.МассивСсылок.Количество() <> 0 Тогда
			...
			Для каждого Ключ Из ТекФорма.МассивСсылок Цикл
				...
				Исключение  
					...
					ДобавитьИнформациюПроверки(_Информация, РежимПроверки, 
						ТекФорма.ИмяФормы, Ключ, КраткоеОписание, Описание);
...
Процедура Отчеты_СформироватьФайлОтчета(Параметры)
	...
	Исключение
		...
		ДобавитьИнформациюПроверки(_Информация, РежимПроверки, 
			ПроверяемыйОбъект,, КраткоеОписание, Описание);
	...
	Иначе
		...
		Если НастройкиВарианта = Неопределено Тогда
			...
			ДобавитьИнформациюПроверки(_Информация, РежимПроверки, 
				ПроверяемыйОбъект,, ОписаниеОшибки, ОписаниеОшибки);
...
Процедура Печать_СформироватьФайлПечатнойФормы(Параметры, ПрефиксФайла = "")
	...
	Исключение
		...
		ДобавитьИнформациюПроверки(_Информация, РежимПроверки, ИмяИсточника, 
			ОбъектПечати, КраткоеОписание, Описание);
	...
	Для Каждого ТекДокумент Из МассивРегистраторов Цикл
		...
		Если ЕстьОшибкиЗаполнения Тогда
			...
			Для Каждого СтрокаСообщения Из СообщенияПользователю Цикл
				...
				ДобавитьИнформациюПроверки(_Информация, РежимПроверки, 
					ИмяМетаданного, Ключ, КраткоеОписание, Описание);
		...
		Исключение
			...
			ДобавитьИнформациюПроверки(_Информация, РежимПроверки, 
				ИмяМетаданного, ТекДокумент, КраткоеОписание, Описание);
...
Процедура СправочникиИПВХ_Проверка()
	...
	Исключение
		...
		ДобавитьИнформациюПроверки(_Информация, РежимПроверки, 
			РежимПроверки,, КраткоеОписание, Описание);
...
Функция Справочники_ПротестироватьОбъектПоСсылкеНаКлиенте(ИмяОбъектаМетаданных, Ссылка)
	...
	Исключение
		...
		ДобавитьИнформациюПроверки(_Информация, РежимПроверки, 
			ПроверяемыйОбъект, Ссылка, КраткоеОписание, Описание);
	...
	Исключение
		...
		ДобавитьИнформациюПроверки(_Информация, РежимПроверки, 
			Форма.ИмяФормы, Ссылка, КраткоеОписание, Описание);
...
Процедура Справочники_ПротестироватьЗаписьОбъектаНаСервере(СсылкаНаОбъект)
	...
	Исключение
		...
		ДобавитьИнформациюПроверки(_Информация, РежимПроверки, 
			ПроверяемыйОбъект, СсылкаНаОбъект, КраткоеОписание, Описание);
...
&НаКлиентеНаСервереБезКонтекста
Функция СтатусыАллюр(Знач СостояниеШага)
